...
const RU = {
  ...
  'hero.h1': 'Почему балансировщик выбрал именно этот outbound',
  'hero.lede':
    'Xray Studio запускает ваш конфиг, доводит каждое решение балансировщика до причины ' +
    'и умеет уронить один outbound так, что это неотличимо от настоящего сетевого сбоя.',
  'hero.download': 'Скачать',
  'hero.github': 'Открыть на GitHub',
  'hero.built': 'Собрано против Xray-core v26.7.28 · macOS · Windows · Linux',
  'hero.caption':
    'Каждый этап настоящего решения <code>leastLoad</code>: кандидаты, арифметика, кто ' +
    'отсеян и почему — и бросок кубика в конце, названный броском кубика.',
