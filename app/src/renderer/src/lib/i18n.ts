...
export const ru: Record<Key, string> = {
  ...
  'topbar.openConfig': 'Открыть конфиг…',
  'topbar.pasteJson': 'Вставить JSON…',
  ...
  'rail.noOutbounds': 'Исходящих пока не видно.',
  ...
  'rail.faultTitle': 'исходящие с внедрённым сбоем',
  'rail.probesInFlight': 'проб в полёте',
  'rail.faultActive': 'внедрён сбой: {kind}',
  'rail.edit': 'править',
  'rail.editTitle': 'Открыть {tag} в графе',
  'rail.untagged':
    'Дозвоны вне какого-либо исходящего — так делают проверка связности и встроенный DNS-клиент. Их нельзя ни править, ни ломать по тегу.',
  ...
  'observe.probesHint':
    'живые исходящие подсвечены; у неудачной пробы нет RTT, поэтому на графике её быть не может',
  'observe.legendFoot':
  ...
  'observe.noBalancerRun':
    'Ни один балансировщик ещё не отрабатывал. Они принимают решение на каждое диспетчеризованное соединение — пропустите трафик через входящий, у которого в правиле стоит balancerTag.',
  'observe.whyThisOutbound': 'Почему именно этот исходящий?',
  'observe.noCandidates': 'нет кандидатов',
  'observe.fallback': 'запасной {tag}',
  ...
  'ai.emptyIntro':
    'Ответы строятся по этому конфигу и по работающему экземпляру: какие исходящие обсерватория считает живыми, их отклонение, причина отсева каждого кандидата и включённые вами сбои.',
  'ai.emptyExamples':
    'Например: «почему ничего не выбирается?» · «что здесь делает costs 5000?» · «этот исходящий никогда не выбирают — почему?»',
  'ai.you': 'вы',
  ...
  'paste.parses': 'Разбирается. Исходящих: {out}, входящих: {in}.',
